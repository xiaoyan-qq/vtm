...
public class ContourRenderer extends ExtrusionRenderer {
    static final Logger log = LoggerFactory.getLogger(ContourRenderer.class);
    ...
    public ContourRenderer(TileRenderer tileRenderer, int zoomMin, int zoomMax,

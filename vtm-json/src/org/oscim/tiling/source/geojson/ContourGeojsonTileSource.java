...
public class ContourGeojsonTileSource extends GeojsonTileSource {
    ...
    public static class Builder<T extends Builder<T>> extends UrlTileSource.Builder<T> {
        ...
        public Builder() {
            super(DEFAULT_URL, DEFAULT_PATH, Viewport.MIN_ZOOM_LEVEL, Viewport.MAX_ZOOM_LEVEL);
            keyName("api_key");
            overZoom(16);
        }
        ...
        public ContourGeojsonTileSource build() {
            return new ContourGeojsonTileSource(this);
        }
    }
    ...
    public ContourGeojsonTileSource(Builder<?> builder) {
        super(builder);
        this.locale = builder.locale;
    }

    public ContourGeojsonTileSource() {
        this(builder());
    }

    public ContourGeojsonTileSource(String urlString) {
